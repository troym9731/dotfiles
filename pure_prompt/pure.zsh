...
prompt_pure_preprompt_render() {
    ...
    # NOTE: I manually added the `%f%F{magenta}` BEFORE the `${prompt_pure_git_dirty}`
		preprompt_parts+=("%F{$git_color}"'${prompt_pure_vcs_info[branch]}%f%F{magenta}${prompt_pure_git_dirty}%f')
	fi
